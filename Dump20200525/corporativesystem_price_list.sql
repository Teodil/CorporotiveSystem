...
CREATE TABLE `price_list` (
  ...
  KEY `fk_Price_List_Product1_idx` (`Product_id`),
  CONSTRAINT `fk_Price_List_Product1` FOREIGN KEY (`Product_id`) REFERENCES `product` (`id`)
...
INSERT INTO `price_list` VALUES (1,35,15,'2020-05-12'),(2,70,15,'2020-02-15'),(3,100,18,'2020-02-15');
